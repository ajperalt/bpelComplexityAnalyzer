...
\emph{Contexto:} \emph{Análisis de procesos de negocio orientados
...
toda la organización \cite{Cardoso2008,DelphiGroup2002}, por lo que
...
esta dotada de \emph{indicadores de proceso} que permiten ajustar
...
\begin{figure}
\hspace*{-1.5in}
\centering{}\caption{ \label{fig:Preocupaciones-del-Gobierno}Preocupaciones del Gobierno
SOA\cite{Weir2013}}


\centering{}\raggedright{}\includegraphics{img/SOAGovernanceConcerns2} 
\end{figure}
...
costosa y necesita de re-ingeniería \cite{Girb2011}, \ugh{A}demás requiere
de múltiples herramientas que solucionan cada preocupación por separado, por lo que se requiere de varios profesionales especializados por
...
\hspace*{-1.5in}
\includegraphics[clip,scale=0.8]{img/Cronograma}
